    ...
    return (
        <div className="max-w-[1240px] mx-auto px-3 mt-16 mb-16">
            ...
            <div className="grid md:grid-cols-5 gap-4 items-center my-10">
                ...
                <Link to="/allPhone">
                    <div className="shadow-md bg-slate-100 scale-100 duration-300 hover:scale-95 relative rounded-md border border-[#008ECC]">
                ...
                <Link to="/allPhone">
                    <div className="shadow-md bg-slate-100 relative duration-300 scale-100 hover:scale-95 rounded-md">
